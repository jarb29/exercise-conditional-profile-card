...
function render(variables = {}) {
  ...
  if (variables.name === null) variables.name = "Luis";
  if (variables.twitter === null) variables.twitter = "alesanchezr";
  if (variables.github === null) variables.github = "lesanchezr";
  if (variables.linkedin === null) variables.linkedin = "jarb29@";
  if (variables.instagram === null) variables.instagram = "Alex";
  ...
  if (variables.socialMediaPosition === "position-left") variables.socialMediaPosition = "position-left";else variables.socialMediaPosition = "position-rigth";
